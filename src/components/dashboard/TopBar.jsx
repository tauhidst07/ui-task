            ...
            <div className="flex-1 max-w-md">
                <div className="relative">
                    ...
                    <input
                        ...
                        className="w-full pl-10 pr-4 py-2 bg-gray-100/50 border border-gray-200 rounded-full focus:outline-none focus:ring-2 focus:ring-[#008DC2]/20 focus:border-[#008DC2] transition-all"
                    />
                </div>
            </div>
